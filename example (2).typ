...
氢气和氧气反应生成水：#chemical[H2 + O2 react 2H2O]

== 列出的反应：
=== 简单反应方程式

#reaction[氢气和氧气生成过氧化氢\
H2 + O2 react H2O2]

=== 复杂反应方程式

#reaction[CH4 + 2O2 react CO2 + 2H2O + Q]

=== 离子反应
#reaction[Fe^(2+) + 2OH^(-) react Fe(OH)2]

=== 平衡反应
#reaction[N2 + 3H2 equilibrium 2NH3]

== 热力学
#reaction[CaCO3 react CaO + CO2, Delta H = 178 kJ/mol]
